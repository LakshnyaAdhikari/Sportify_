  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        'sans': ['Hind', 'Noto Sans', 'system-ui', 'sans-serif'],
      },
      colors: {
        /* India Flag Inspired Colors */
        saffron: {
        ...
        "india-green": {
          ...
          dark: "hsl(var(--india-green-dark))",
        },
        "india-blue": {
          DEFAULT: "hsl(var(--india-blue))",
          light: "hsl(var(--india-blue-light))",
        },
